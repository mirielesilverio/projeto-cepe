 ...
 * @author Aluno
 */
public class PerfilDiretor extends javax.swing.JFrame {

    private static Usuario usuario = new Usuario();
    private static EstadoAccess estado;
    private static CidadeAccess cidade;
    public PerfilDiretor(Usuario usuario) {
        initComponents();
        this.usuario = usuario;
        this.setLocationRelativeTo(null);
        jLabel2.setText(usuario.getNome()+" "+usuario.getSobrenome());
        lblDataNascTexto.setText(usuario.getDataNasc());
        ...
        lblCPFTexto.setText(usuario.getCPF());
        lblRGTexto.setText(usuario.getRG());
        lblTelefoneTexto.setText(usuario.getTelefone());
        
        estado = new EstadoAccess();
        lblEstadoTexto.setText(estado.read(usuario.getEstado()).getNome());
        
        cidade = new CidadeAccess();
        lblCidadeTexto.setText(cidade.read(usuario.getEstado(),usuario.getCidade()).getNome());
        
        lblRuaTexto.setText(usuario.getRua());
        lblBairroTexto1.setText(usuario.getBairro());
        lblNumeroTexto.setText(String.valueOf(usuario.getNum()));
        lblEmailTexto.setText(usuario.getEmail());
    }
    ...
    private void initComponents() {
        ...
        btnVoltar.setBounds(40, 20, 40, 33);
        ...
        pnDados.add(jLabel2);
        jLabel2.setBounds(310, 40, 520, 31);
        ...
        pnDados.add(lblBairroTexto1);
        lblBairroTexto1.setBounds(580, 390, 290, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilDiretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerfilDiretor(usuario).setVisible(true);
            }
        });
    }
